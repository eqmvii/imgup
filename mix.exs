defmodule ImgupApp.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind imgup_app", "esbuild imgup_app"],
      "assets.deploy": [
        "tailwind imgup_app --minify",
        "esbuild imgup_app --minify",
        "phx.digest"
      ]
    ]
  end
